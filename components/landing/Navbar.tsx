      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center">
            <Image src="/logo-tcnoflex.png" alt="TCNOflex" width={140} height={48} priority />
          </Link>
      ...
      {open && (
        <div className="md:hidden bg-surface border-b border-border px-4 pb-4">
          <div className="flex flex-col gap-3">
            ...
            <Link href="/login" className="bg-primary hover:bg-primary-dark text-white px-5 py-2 rounded-lg text-center font-medium">Ingresar</Link>
          </div>
        </div>
      )}
    </nav>
